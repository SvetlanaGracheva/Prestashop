...
public class Constants {
    ...
    public static final String EMAIL = "ivanov123@mailto.plus";
    public static final String PASSWORD = "qwe123";
    public static final String EMAIL_CREATE = "ivanov123@mailto.plus";
    ...
    public static final String PASSWORD_CREATE = "qwe123";
