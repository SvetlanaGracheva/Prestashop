...
public class Constants {
    ...
    public static final String EMAIL = "testqwert@mail.ru";
    public static final String PASSWORD = "qwert";
    public static final String PASSWORDFALSE = "123456";
    public static final String EMAILCREATE = "grswet@mail.ru";
    ...
    public static final String LASTNAME ="DIPLOM";
    public static final String PASSWORDCREATE = "QWERTY";
